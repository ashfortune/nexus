...
export default function IndustryBoardDetailPage() {
  ...
  useEffect(() => {
    if (params.id) {
      ...
      } else if (post?.industryCategoryId) {
    ...
    <div className="min-h-screen bg-[var(--nexus-bg)] py-12 px-6 pb-32">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          <button 
            onClick={() => router.push("/industry-board")}
          ...
          <div className="p-8 md:p-14">
            <header className="mb-14 pb-14 border-b border-zinc-50">
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Industry Expertise</span>
              </div>
            ...
            <div className="pt-10 border-t border-zinc-50 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-bold text-zinc-400">비즈니스 노하우를 정중하게 나눠주세요.</p>
              </div>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-4 mb-10 ml-4">
            ...
            <div>
              <h2 className="text-2xl font-black text-zinc-900 leading-none mb-1.5">INSIGHTS</h2>
              <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">{comments.length} professional comments</p>
            </div>
          </div>
          ...
          <div className="nexus-card bg-white p-6 md:p-10 mb-10 shadow-2xl shadow-black/5">
            <div className="relative group">
              <textarea 
                ...
                placeholder="사장님의 소중한 의견을 보태주세요."
            ...
            <div className="divide-y divide-zinc-50">
              {comments.length > 0 ? (
                ...
                <div className="p-20 text-center bg-zinc-50/30">
                  ...
                  <p className="text-zinc-400 font-black text-sm tracking-tighter italic">가장 먼저 비즈니스 인사이트를 나누어 보세요!</p>
                </div>
              )}
            </div>
          </div>
        ...
        <section className="space-y-10">
          <div className="flex items-center justify-between ml-4">
            <h3 className="text-2xl font-black text-zinc-900 tracking-tighter uppercase">More in {post.industryCategoryName}</h3>
            <button 
              onClick={() => router.push(`/industry-board?categoryId=${post.industryCategoryId}`)}
              ...
              <tbody className="divide-y divide-zinc-50">
                {posts.map((p, index) => (
                  <tr 
                    ...
                    onClick={() => {
                      if (p.id !== post.id) {
                        router.push(`/industry-board/detail/${p.id}`);
                      }
                    }}
                    className={cn(
                  ...
                  >
                    ...
                    <td className="py-5 px-6">
                      <div className="flex items-center gap-3">
                        ...
                        {p.id === post.id && (
                          <span className="px-2 py-0.5 bg-[var(--nexus-primary)] text-white text-[8px] font-black uppercase rounded-full">Viewing</span>
                        )}
                      </div>
                    </td>
