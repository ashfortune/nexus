    ...
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-500 font-medium max-w-xl mx-auto text-sm leading-relaxed">
          인공지능이 제안하는 브랜드 컨셉입니다. 마음에 드는 디자인을 선택하시면 브랜드의 핵심
          아이덴티티가 완성됩니다.
        </p>
        {!logos.length && (
          <div className="pt-6">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-8 bg-white border border-[var(--nexus-outline-variant)]/30 rounded-[2.5rem] shadow-sm flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-[var(--nexus-on-bg)] italic opacity-70">
                "{identity?.slogan}"
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between px-2">
            <h3 className="text-2xl font-black text-[var(--nexus-on-bg)] tracking-tight">
              Curated Designs
            </h3>
            {logos.length > 0 && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {isGenerating ? (
              [1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="aspect-square bg-[var(--nexus-surface-low)] rounded-[3rem] border border-[var(--nexus-outline-variant)]/20 flex flex-col items-center justify-center gap-6 animate-pulse"
                >
      ...
      <div className="bg-[var(--nexus-surface-low)] border border-[var(--nexus-outline-variant)]/40 rounded-2xl p-5 flex items-start gap-4">
        ...
        <div className="space-y-1">
          <h4 className="text-xs font-bold text-[var(--nexus-on-bg)]">
            Notice: 저작권 및 상표권 안내
          </h4>
          <p className="text-xs text-gray-500 leading-relaxed">
            AI가 제안하는 본 로고 디자인은 창업 준비를 위한 <strong>초안(Draft) 용도</strong>입니다.
            실제 상표(Trademark) 등록 및 상업적 사용을 위해서는 KIPRIS 등을 통한{' '}
            <strong>유사성 검토와 전문가의 리터칭</strong>을 권장합니다.
          </p>
        </div>
      </div>
