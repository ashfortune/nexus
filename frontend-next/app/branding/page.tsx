...
export default function BrandListPage() {
  ...
  const getIndustryIcon = (industry: string) => {
    switch (industry.toLowerCase()) {
      case 'tech':
        return <Rocket className="w-12 h-12 text-blue-500" />;
      case 'design':
        return <Palette className="w-12 h-12 text-purple-500" />;
      case 'marketing':
        return <LineChart className="w-12 h-12 text-green-500" />;
      case 'e-commerce':
        ...
        <main className="max-w-7xl mx-auto px-6 py-16">
          ...
          <section className="text-left mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="space-y-4">
              ...
              <h2 className="text-6xl font-black tracking-tight leading-[0.9]">
                Nexus Brand
                <br />
                <span className="text-[var(--nexus-primary)]">Command Center</span>
              </h2>
              <p className="text-gray-500 font-medium text-lg">
                혁신적인 브랜딩 여정을 한곳에서 관리하세요.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <aside className="lg:col-span-4 space-y-8">
              <div className="sticky top-32">
                <h3 className="text-4xl font-black tracking-tight mb-2 text-[var(--nexus-primary)]">
                  Overview
                </h3>
                  ...
                  {selectedBrand ? (
                    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-black text-[var(--nexus-on-bg)] mb-1">
                            {selectedBrand.title}
                          </h4>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-center space-y-6">
                      ...
                      <div>
                        <h4 className="text-xl font-black text-[var(--nexus-on-bg)] mb-2">
                          Ready to Launch
                        </h4>
                        <p className="text-sm text-gray-500 font-medium leading-relaxed px-4">
                          왼쪽의 브랜드 카드를 선택하여 세부 관리 메뉴를 활성화하세요.
                        </p>
                      </div>
                    </div>
                  )}
