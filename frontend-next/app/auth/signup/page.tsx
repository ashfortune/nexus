              ...
              >
                <div
                  className={cn(
                    ...
                    agreedPolicies.length === POLICIES.length
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={cn(
                          ...
                          agreedPolicies.includes(policy.id)
                            ? 'bg-black border-black'
                            : 'border-zinc-300'
                        )}
                      ...
                      <span className="text-sm font-medium text-zinc-800">
                        {policy.id}. {policy.title} (필수)
                      </span>
                    </div>
                    <p className="text-xs text-zinc-500 leading-relaxed pl-8">{policy.detail}</p>
                  </div>
                ))}
              </div>
            </div>
                ...
                <div className="text-center">
                  ...
                  <div
                    className={cn(
                      ...
                      selectedType === 0 ? 'text-zinc-100' : 'text-zinc-500'
                    )}
                  >
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <div
                    className={cn(
                      'text-xs mt-1 opacity-70',
                      selectedType === 1 ? 'text-zinc-100' : 'text-zinc-500'
                    )}
                  >
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                {errors.address && (
                  <p className="text-xs text-red-500 mt-1 ml-1">{errors.address.message}</p>
                )}
              </div>
              ...
              {watchUserType === 1 && (
                <div className="space-y-1.5 p-5 bg-black/[0.02] border border-black/10 rounded-2xl">
                  ...
                  {errors.bizNo && (
                    <p className="text-xs text-red-500 flex items-center gap-1 mt-1 ml-1">
                      <AlertCircle className="w-3 h-3" /> {errors.bizNo.message}
                    </p>
                  )}
                </div>
              )}
