    ...
    <div className="min-h-screen bg-[var(--nexus-bg)] text-[var(--nexus-on-bg)] p-8 pb-32">
      <div className="max-w-4xl mx-auto">
        <header className="mb-12">
          ...
          <span className="text-[var(--nexus-primary)] font-black tracking-[0.4em] text-[10px] uppercase mb-3 block opacity-60">
            Seller Center
          </span>
          ...
          <p className="text-slate-500 mt-4 text-lg font-medium">
            당신의 제안이 가치가 되도록 상세 정보를 입력해 주세요.
          </p>
        </header>

        <form
          onSubmit={handleSubmit}
          className="nexus-card p-16 shadow-2xl border-2 border-white space-y-12"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              <input
                ...
                placeholder="가장 매력적인 공동구매 제목을 지어주세요"
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-[1.5rem] px-8 py-6 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-[var(--nexus-primary)] transition-all font-black text-2xl placeholder:text-slate-200"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="정확한 상품명"
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-5 focus:outline-none focus:border-[var(--nexus-primary)] font-bold text-lg transition-all"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="0"
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-5 focus:outline-none focus:border-[var(--nexus-primary)] font-black text-lg transition-all"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-6 py-5 focus:outline-none focus:border-[var(--nexus-primary)] font-black text-lg transition-all [color-scheme:light]"
              />
            </div>
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={8}
                placeholder="참여자들이 신뢰할 수 있도록 제품의 상세한 정보와 공동구매 취지를 적어주세요."
                className="w-full bg-slate-50 border-2 border-slate-100 rounded-[2.5rem] px-10 py-8 focus:outline-none focus:border-[var(--nexus-primary)] font-medium text-xl resize-none transition-all placeholder:text-slate-200"
              />
            </div>
          </div>
