...
function PaymentSuccessContent() {
  ...
  useEffect(() => {
    const confirmParticipation = async () => {
      ...
      try {
        const response = await api.post(`/api/v1/group-purchases/${params.id}/confirm-payment`, {
        ...
        {status === 'loading' && (
          <div className="space-y-8 py-10">
            ...
            <div className="space-y-3">
              <h1 className="text-2xl font-black text-[var(--nexus-primary)] uppercase tracking-tighter">
                결제 확인 중...
              </h1>
        ...
        {status === 'success' && (
          <>
            ...
            <div className="space-y-4">
              <span className="text-[var(--nexus-primary)] font-black tracking-[0.4em] text-[10px] uppercase block opacity-50">
                Payment Confirmed
              </span>
            ...
            <div className="bg-[var(--nexus-bg)] rounded-[2.5rem] p-8 space-y-4 border border-white shadow-inner">
              ...
              <div className="flex justify-between items-center px-2">
                ...
                <span className="text-[var(--nexus-primary)] font-black text-xl">
            ...
            <p className="text-slate-400 font-medium text-sm leading-relaxed">
              함께해주셔서 감사합니다.
              <br />
              <span className="text-[var(--nexus-primary)] font-black">
                목표 인원이 달성되면
              </span>{' '}
              가장 먼저 알려드릴게요.
            </p>
          ...
          <>
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-500 font-medium leading-relaxed px-4">
                결제는 완료되었으나 참여 정보 저장 중 오류가 발생했습니다.
                <br />
