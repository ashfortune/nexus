    ...
    <div className="min-h-screen bg-[var(--nexus-bg)] text-[var(--nexus-on-bg)] p-8 pb-24 font-sans">
      <div className="max-w-7xl mx-auto">
        <header className="flex justify-between items-end mb-12">
          <div>
            <span className="text-[var(--nexus-primary)] font-black tracking-[0.3em] text-xs uppercase mb-3 block opacity-60">
              Premium Marketplace
            </span>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-32 bg-white/40 backdrop-blur-sm rounded-[4rem] border-4 border-dashed border-white/60">
            ...
            <Link href="/group-purchases/create">
              <span className="text-[var(--nexus-primary)] font-black hover:underline cursor-pointer">
                첫 번째 공동구매를 등록해 보세요!
              </span>
            </Link>
          </div>
                  ...
                  <div className="p-8 space-y-7 bg-white">
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        <h3 className="text-xl font-black text-[#0f172a] line-clamp-1 group-hover:text-[var(--nexus-primary)] transition-colors flex-1">
                          {gb.title}
                        </h3>
                    ...
                    <div className="flex justify-between items-end border-b border-slate-50 pb-2">
                      <div className="space-y-1">
                        ...
                        <p className="text-2xl font-black text-[var(--nexus-primary)] tracking-tighter">
                          {gb.itemPrice.toLocaleString()}원
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="text-slate-600 font-black">
                          {gb.currentCount} <span className="text-slate-200">/</span>{' '}
                          {gb.targetCount}명
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <p
                        className={`text-[10px] font-black tracking-[0.2em] uppercase ${isCompleted ? 'text-slate-400' : 'text-[var(--nexus-primary)]'}`}
                      >
