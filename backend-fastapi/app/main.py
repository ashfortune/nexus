...
from app.domain.industryChange import industryChangeRouter as industryChange
...
app.include_router(industryChange.router, prefix="/api/v1/ai/industry-change", tags=["Industry Change"])
